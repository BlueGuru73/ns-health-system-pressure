...
This project also sparked an interest in further exploring health system pressure indicators. As a continuation of this work, I plan to pursue an independent exploratory analysis examining the underlying drivers of emergency department wait times in Canada and Nova Scotia. This future work would investigate relationships between healthcare demand, hospital capacity, and seasonal illness trends to better understand how system strain develops and how early signals might support proactive health system planning
